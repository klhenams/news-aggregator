...
from app.schemas import NewsCreate, NewsListResponse, NewsResponse
...
class NewsService:
    ...
    async def get_articles(
        ...
        try:
            ...
            return NewsListResponse(
                articles=articles, total=total, page=page, per_page=per_page
            )
    ...
    async def update_article(
        self, article_id: str, updates: dict  # type: ignore[type-arg]
    ...
    async def bulk_create_articles(
        self, articles: List[NewsCreate]
    ) -> List[NewsResponse]:
        """Bulk create articles."""
        try:
            # Check if repository supports bulk create
            if hasattr(self.repository, "bulk_create"):
                return await self.repository.bulk_create(articles)  # type: ignore[no-any-return]
            else:
    ...
    async def health_check(self) -> dict:  # type: ignore[type-arg]
        ...
        try:
            ...
            return {"service": "healthy", "repository": repo_health}
        except Exception as e:
