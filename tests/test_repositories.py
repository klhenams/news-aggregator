...
class TestRepositoryFactory:
    ...
    async def test_singleton_repository(self):
        ...
        repo1 = await NewsRepositoryFactory.get_singleton_repository(
            DataSourceType.MEMORY
        )
        repo2 = await NewsRepositoryFactory.get_singleton_repository(
            DataSourceType.MEMORY
        )
    ...
    def test_register_custom_repository(self):
        ...
        NewsRepositoryFactory.register_repository(
            DataSourceType.REDIS, CustomRepository  # Using future type for test
        )
